  ...
  return (
    <div className="bg-slate-900 border border-slate-800/80 rounded-lg p-3.5 flex flex-col gap-3.5 animate-fade-in shadow-xl shadow-black/20">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        {/* Scanned vs Discovered Counters */}
